...
def always_roll(n):
    ...
    return always_roll_n  #always_roll(5) would be equivalent to always_roll_5
    # END PROBLEM 6
...
def make_averaged(original_function, total_samples=1000):
    ...
    def avg_value(*args):   
        total = 0
        dice_num = 1
        while dice_num <= total_samples:
            total, dice_num = total + original_function(*args), dice_num+1
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while i <= 10:
        ...
        max_score_i = averaged_dice(i, dice)
        if max_score_i > max_score:
            max_score = max_score_i
            lower_dice_num = i
        i += 1
    
    return lower_dice_num
    # END PROBLEM 9
